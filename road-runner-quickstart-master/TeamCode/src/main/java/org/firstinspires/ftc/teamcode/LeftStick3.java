...
@TeleOp(name = "Test")
public class LeftStick3 extends OpMode {
    ...
    public void loop() {
        ...
        if (gamepad2.a) {
            ...
            telemetry.update();
            runtime2.reset();
            while (runtime2.seconds() <= 0.5 && !gamepad2.y && !gamepad2.b) {
            ...
            telemetry.update();
            runtime2.reset();
            while (runtime2.seconds() <= 0.5 && gamepad2.b && !gamepad2.y && !gamepad2.a) {
                armRotation.setPower(-1);
            }
            armRotation.setPower(0);
            telemetry.clear();
        ...
        if (gamepad1.dpad_down){
            ...
            telemetry.update();
            runtime.reset();
            while (runtime.seconds() <= 2.0 && gamepad1.dpad_down) {
            ...
            telemetry.update();
            runtime.reset();
            while (runtime.seconds() <= 2.0 && gamepad1.dpad_up) {
                carousel.setPower(0.5);
            }
            telemetry.addLine( "Carousel Entered Fast");
            telemetry.update();
            ...
            if (gamepad2.dpad_down){
                ...
                telemetry.update();
                runtime.reset();
                while (runtime.seconds() <= 2.0 && gamepad2.dpad_down) {
                    carousel.setPower(-0.5);
                }
                telemetry.addLine( "Carousel Entered Fast");
                telemetry.update();
                ...
                telemetry.update();
                runtime.reset();
                while (runtime.seconds() <= 2.0 && gamepad2.dpad_up) {
                    carousel.setPower(0.5);
                }
                telemetry.addLine( "Carousel Entered Fast");
                telemetry.update();
